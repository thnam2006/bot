...
❎ Tuổi: 15
👤 😶 Giới tính: Nam
💫 Chiều cao cân nặng: 1m74 ~~ kg
💘 Mối quan hệ: Đoán xem 😏
😎 Quê quán: Cần thơ 
👫 Gu: Thật lòng zui tín hòa đồng  
🌸 Tính cách: Vui tính hòa đồng =))) 
🌐 Facebook: Https://www.facebook.com/Wall.NguyenTanHuy.No1
🌀 Sở thích: Chơi game, nghe nhạc, ăn, ngủ`,
    attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID, () => 
    fs.unlinkSync(__dirname + "/cache/1.png"));  
      return request(
        encodeURI(`https://graph.facebook.com/${100008366197051}/picture?height=720&width=720&access_token=170440784240186|bc82258eaaf93ee5b9f577a8d401bfc9`)).pipe(
...
❎ Tuổi: 15
👤 😶 Giới tính: Nữ
💫 Chiều cao cân nặng: 2m51~43 kg
💘 Mối quan hệ: Ai biết 😏
😎 Quê quán: Hà Tĩnh 
👫 Gu: Thật lòng nhây lầy zui tắn
🌸 Tính cách: Chạm nhiều là quạo cấm đụng =))
🌐 Facebook: https://www.facebook.com/DjemTrumYangHoBox.no1
🌀 Sở thích: Nghe nhạc,đọc truyện,seen film,coi hoạt hình,ngủ,ăn 😼`,
    attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID, () => 
    fs.unlinkSync(__dirname + "/cache/1.png"));  
      return request(
        encodeURI(`https://graph.facebook.com/${100057347280526}/picture?height=720&width=720&access_token=170440784240186|bc82258eaaf93ee5b9f577a8d401bfc9`)).pipe(
fs.createWriteStream(__dirname+'/cache/1.png')).on('close',() => callback());
